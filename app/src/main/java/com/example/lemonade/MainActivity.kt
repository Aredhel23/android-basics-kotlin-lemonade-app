...
class MainActivity : AppCompatActivity() {
    ...
    private fun setViewElements() {
        ...
        val lemonView: ImageView = findViewById(R.id.image_lemon_state)
        when (lemonadeState) {
            SELECT -> {
                textAction.setText(R.string.lemon_select)
                lemonView.setImageResource(R.drawable.lemon_tree)
            }
            DRINK -> {
                textAction.setText(R.string.lemon_drink)
                lemonView.setImageResource(R.drawable.lemon_drink)
            }
            SQUEEZE -> {
                textAction.setText(R.string.lemon_squeeze)
                lemonView.setImageResource(R.drawable.lemon_squeeze)
            }
            RESTART -> {
                textAction.setText(R.string.lemon_empty_glass)
                lemonView.setImageResource(R.drawable.lemon_restart)
            }
        }
